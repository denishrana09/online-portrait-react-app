      ...
      <Layout>
        <Helmet>
          ...
          <meta name="description"
            content="We don't story cookies. we don't share any kind of users data, so feel free to use site."
          />
          <meta name="og:title" property="og:title" content="Privacy Policy" />
          <meta name="og:title" property="og:description" content="We don't story cookies. we don't share any kind of users data, so feel free to use site." />
          <meta name="keywords" content="art, portrait, online portrait" />
        </Helmet>
        <div className="container">
          <h1>Privacy Policy of onlineportrait.in</h1>

          <p>
            OnlinePortrait operates the onlineportrait.in website, which provides the
              service of giving black and whiter, color sketch/portrait, or whatever type of art user wants.
          </p>

          <p>
            This page is used to inform website visitors regarding our policies
            with the collection, use, and disclosure of Personal Information if
            anyone decided to use our Service, the onlineportrait.in website.
          </p>
          ...
          <p>
            ...
            our Terms and Conditions, which is accessible at onlineportrait.in, unless
